...
print('\n#####    Linear Combination Vector for Jane/Restaurant(s) Pair Scores     #####')
...
print('\n_______________________________________________________________________________')
print('\n#####  The BEST Restaurants for the entire office, given scoring criteria #####')
...
# Printing out the Best Restaurants for all individuals
print('\n_______________________________________________________________________________')
print('\n\n#####  The BEST Restaurants for Each Person/Employee  ######')
count = 0
...
print('\n_______________________________________________________________________________')
print('\n#####  Problem People Profiles, Varies more than ±25% from mean scores  ######\n')
...
print('\nPCA PeopleMatrix component weights:',pca.components_)
print('\nPCA PeopleMatrix % explained variance: ',pca.explained_variance_)
...
print ('\n3-clusters peopleMatrixPcaTransform KMeans cluster centroids:',centroid)
print('\npeopleMatrixPcaTransform Labels:',labels)
